...
public class AsrManager {
     ...
     *
     * @param context
     * @param onAsrListener 将EventListener结果做解析的DEMO回调。使用RecogEventAdapter 适配EventListener
     */
    public AsrManager(Context context, IOnAsrListener onAsrListener) {
        this(context, new RecogEventAdapter(onAsrListener));
    }
    ...
    public void setEventListener(IOnAsrListener recogListener) {
        if (!isInited) {
            throw new RuntimeException("release() was called");
        }
